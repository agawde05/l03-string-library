...
int main() {
  ...
  try {
    ...
    // ERASE TEST 1
    if (test_number == 1 || test_number == TEST_ALL ||
        test_number == TEST_ERASE) {
      printf("======================================== 01 "
             "========================================");
    ...
    // ERASE TEST 2
    if (test_number == 2 || test_number == TEST_ALL ||
        test_number == TEST_ERASE) {
      printf("======================================== 02 "
             "========================================");
    ...
    // ERASE TEST 3
    if (test_number == 3 || test_number == TEST_ALL ||
        test_number == TEST_ERASE) {
      printf("======================================== 03 "
             "========================================");
    ...
    // ERASE TEST 4
    if (test_number == 4 || test_number == TEST_ALL ||
        test_number == TEST_ERASE) {
      printf("======================================== 04 "
             "========================================");
    ...
    // ERASE TEST 5
    if (test_number == 5 || test_number == TEST_ALL ||
        test_number == TEST_ERASE) {
      printf("======================================== 05 "
             "========================================");
    ...
    // ERASE TEST 6
    if (test_number == 6 || test_number == TEST_ALL ||
        test_number == TEST_ERASE) {
      printf("======================================== 06 "
             "========================================");
    ...
    // ERASE TEST 7
    if (test_number == 7 || test_number == TEST_ALL ||
        test_number == TEST_ERASE) {
      printf("======================================== 07 "
             "========================================");
    ...
    // ERASE TEST 8
    if (test_number == 8 || test_number == TEST_ALL ||
        test_number == TEST_ERASE) {
      printf("======================================== 08 "
             "========================================");
    ...
    // ERASE TEST 9
    if (test_number == 9 || test_number == TEST_ALL ||
        test_number == TEST_ERASE) {
      printf("======================================== 09 "
             "========================================");
    ...
    // ERASE TEST 10
    if (test_number == 10 || test_number == TEST_ALL ||
        test_number == TEST_ERASE) {
      printf("======================================== 10 "
             "========================================");
    ...
    // ERASE TEST 11
    if (test_number == 11 || test_number == TEST_ALL ||
        test_number == TEST_ERASE) {
      printf("======================================== 11 "
             "========================================");
    ...
    // INSERT TEST 1
    if (test_number == 12 || test_number == TEST_ALL ||
        test_number == TEST_INSERT) {
      printf("======================================== 12 "
             "========================================");
    ...
    // INSERT TEST 2
    if (test_number == 13 || test_number == TEST_ALL ||
        test_number == TEST_INSERT) {
      printf("======================================== 13 "
             "========================================");
    ...
    // INSERT TEST 3
    if (test_number == 14 || test_number == TEST_ALL ||
        test_number == TEST_INSERT) {
      printf("======================================== 14 "
             "========================================");
    ...
    // INSERT TEST 4
    if (test_number == 15 || test_number == TEST_ALL ||
        test_number == TEST_INSERT) {
      printf("======================================== 15 "
             "========================================");
    ...
    // INSERT TEST 5
    if (test_number == 16 || test_number == TEST_ALL ||
        test_number == TEST_INSERT) {
      printf("======================================== 16 "
             "========================================");
    ...
    // INSERT TEST 6
    if (test_number == 17 || test_number == TEST_ALL ||
        test_number == TEST_INSERT) {
      printf("======================================== 17 "
             "========================================");
      printf("\nRUNNING TEST INSERT 6 ...\n");
      printf("  ORIGINAL STRING: \"When I start my 281 project, the first "
             "thing I think of is FUN\"\n");
      printf("  OPERATION: insert(61, \"NCTIO\")\n");
      fflush(stdout);
      String act =
          "When I start my 281 project, the first thing I think of is FUN";
      act.insert(61, "NCTIO");
      String exp =
          "When I start my 281 project, the first thing I think of is FUNCTION";
      bool success = check_sol(act, exp);
      if (success) {
    ...
    // INSERT TEST 7
    if (test_number == 18 || test_number == TEST_ALL ||
        test_number == TEST_INSERT) {
      printf("======================================== 18 "
             "========================================");
    ...
    // INSERT TEST 8
    if (test_number == 19 || test_number == TEST_ALL ||
        test_number == TEST_INSERT) {
      printf("======================================== 19 "
             "========================================");
    ...
    // INSERT TEST 9
    if (test_number == 20 || test_number == TEST_ALL ||
        test_number == TEST_INSERT) {
      printf("======================================== 20 "
             "========================================");
    ...
    // INSERT TEST 10
    if (test_number == 21 || test_number == TEST_ALL ||
        test_number == TEST_INSERT) {
      printf("======================================== 21 "
             "========================================");
    ...
    // INSERT TEST 11
    if (test_number == 22 || test_number == TEST_ALL ||
        test_number == TEST_INSERT) {
      printf("======================================== 22 "
             "========================================");
    ...
    // REPLACE TEST 1
    if (test_number == 23 || test_number == TEST_ALL ||
        test_number == TEST_REPLACE) {
      printf("======================================== 23 "
             "========================================");
    ...
    // REPLACE TEST 2
    if (test_number == 24 || test_number == TEST_ALL ||
        test_number == TEST_REPLACE) {
      printf("======================================== 24 "
             "========================================");
    ...
    // REPLACE TEST 3
    if (test_number == 25 || test_number == TEST_ALL ||
        test_number == TEST_REPLACE) {
      printf("======================================== 25 "
             "========================================");
    ...
    // REPLACE TEST 4
    if (test_number == 26 || test_number == TEST_ALL ||
        test_number == TEST_REPLACE) {
      printf("======================================== 26 "
             "========================================");
    ...
    // REPLACE TEST 5
    if (test_number == 27 || test_number == TEST_ALL ||
        test_number == TEST_REPLACE) {
      printf("======================================== 27 "
             "========================================");
    ...
    // REPLACE TEST 6
    if (test_number == 28 || test_number == TEST_ALL ||
        test_number == TEST_REPLACE) {
      printf("======================================== 28 "
             "========================================");
    ...
    // REPLACE TEST 7
    if (test_number == 29 || test_number == TEST_ALL ||
        test_number == TEST_REPLACE) {
      printf("======================================== 29 "
             "========================================");
    ...
    // REPLACE TEST 8
    if (test_number == 30 || test_number == TEST_ALL ||
        test_number == TEST_REPLACE) {
      printf("======================================== 30 "
             "========================================");
    ...
    // REPLACE TEST 9
    if (test_number == 31 || test_number == TEST_ALL ||
        test_number == TEST_REPLACE) {
      printf("======================================== 31 "
             "========================================");
    ...
    // REPLACE TEST 10
    if (test_number == 32 || test_number == TEST_ALL ||
        test_number == TEST_REPLACE) {
      printf("======================================== 32 "
             "========================================");
    ...
    // REPLACE TEST 11
    if (test_number == 33 || test_number == TEST_ALL ||
        test_number == TEST_REPLACE) {
      printf("======================================== 33 "
             "========================================");
    ...
    // REPLACE TEST 12
    if (test_number == 34 || test_number == TEST_ALL ||
        test_number == TEST_REPLACE) {
      printf("======================================== 34 "
             "========================================");
    ...
    // REPLACE TEST 13
    if (test_number == 35 || test_number == TEST_ALL ||
        test_number == TEST_REPLACE) {
      printf("======================================== 35 "
             "========================================");
    ...
    // REPLACE TEST 14
    if (test_number == 36 || test_number == TEST_ALL ||
        test_number == TEST_REPLACE) {
      printf("======================================== 36 "
             "========================================");
    ...
    // REPLACE TEST 15
    if (test_number == 37 || test_number == TEST_ALL ||
        test_number == TEST_REPLACE) {
      printf("======================================== 37 "
             "========================================");
    ...
    // REPLACE TEST 16
    if (test_number == 38 || test_number == TEST_ALL ||
        test_number == TEST_REPLACE) {
      printf("======================================== 38 "
             "========================================");
    ...
    // REPLACE TEST 17
    if (test_number == 39 || test_number == TEST_ALL ||
        test_number == TEST_REPLACE) {
      printf("======================================== 39 "
             "========================================");
      printf("\nRUNNING TEST REPLACE 17 ...\n");
      printf("  ORIGINAL STRING: \"wants12934875rgywe\"\n");
      printf("  OPERATION: replace(0, 0, "
             "\"ufeisiohusopT$*(&YEGUity4irjgoiuij\")\n");
      fflush(stdout);
    ...
    // REPLACE TEST 18
    if (test_number == 40 || test_number == TEST_ALL ||
        test_number == TEST_REPLACE) {
      printf("======================================== 40 "
             "========================================");
    ...
    // REPLACE TEST 19
    if (test_number == 41 || test_number == TEST_ALL ||
        test_number == TEST_REPLACE) {
      printf("======================================== 41 "
             "========================================");
    ...
    // REPLACE TEST 20
    if (test_number == 42 || test_number == TEST_ALL ||
        test_number == TEST_REPLACE) {
      printf("======================================== 42 "
             "========================================");
    ...
    if (test_number == 43 || test_number == TEST_ALL ||
        test_number == TEST_FFO) {
      printf("======================================== 43 "
             "========================================");
      printf("\nRUNNING TEST FIND_FIRST_OF 1 ...\n");
      printf("  ORIGINAL STRING: \"the quick brown fox jumps over the lazy "
             "dog\"\n");
      printf("  OPERATIONS: find_first_of(<all characters from A to Z>)\n");
      fflush(stdout);
      String act = "the quick brown fox jumps over the lazy dog";
      size_t solution[26] = {36, 10, 7,  40, 2,  16, 42, 1, 6,  20, 8,  35, 22,
                             14, 12, 23, 4,  11, 24, 0,  5, 27, 13, 18, 38, 37};
      bool passed = true;
      ...
      for (int i = 0; i < 26; ++i) {
        ...
        if (res != solution[i]) {
          ...
          printf(
              "  EXPECTED INDEX %zu FOR CHARACTER \'%c\', BUT GOT INDEX %zu\n",
    ...
    if (test_number == 44 || test_number == TEST_ALL ||
        test_number == TEST_FFO) {
      printf("======================================== 44 "
             "========================================");
    ...
    if (test_number == 45 || test_number == TEST_ALL ||
        test_number == TEST_FFO) {
      printf("======================================== 45 "
             "========================================");
    ...
    if (test_number == 46 || test_number == TEST_ALL ||
        test_number == TEST_FFO) {
      printf("======================================== 46 "
             "========================================");
    ...
    if (test_number == 47 || test_number == TEST_ALL ||
        test_number == TEST_FFO) {
      printf("======================================== 47 "
             "========================================");
    ...
    if (test_number == 48 || test_number == TEST_ALL ||
        test_number == TEST_FFO) {
      printf("======================================== 48 "
             "========================================");
      printf("\nRUNNING TEST FIND_FIRST_OF 6 ...\n");
      printf("  ORIGINAL STRING: \"Words in parentheses can (not) be "
             "ignored.\"\n");
      printf("  OPERATION: find_first_of(\"?!.)(!\")\n");
      fflush(stdout);
    ...
    if (test_number == 49 || test_number == TEST_ALL ||
        test_number == TEST_FFO) {
      printf("======================================== 49 "
             "========================================");
    ...
    if (test_number == 50 || test_number == TEST_ALL ||
        test_number == TEST_FFO) {
      printf("======================================== 50 "
             "========================================");
    ...
    if (test_number == 51 || test_number == TEST_ALL ||
        test_number == TEST_FFO) {
      printf("======================================== 51 "
             "========================================");
    ...
    if (test_number == 52 || test_number == TEST_ALL ||
        test_number == TEST_FFO) {
      printf("======================================== 52 "
             "========================================");
    ...
    if (test_number == 53 || test_number == TEST_ALL ||
        test_number == TEST_FFO) {
      printf("======================================== 53 "
             "========================================");
    ...
    if (test_number == 54 || test_number == TEST_ALL ||
        test_number == TEST_FFO) {
      printf("======================================== 54 "
             "========================================");
    ...
    if (test_number == 55 || test_number == TEST_ALL ||
        test_number == TEST_FFO) {
      printf("======================================== 55 "
             "========================================");
    ...
    if (test_number == 56 || test_number == TEST_ALL ||
        test_number == TEST_FFO) {
      printf("======================================== 56 "
             "========================================");
    ...
    // Test Find Last Of 1
    if (test_number == 57 || test_number == TEST_ALL ||
        test_number == TEST_FLO) {
      printf("======================================== 57 "
             "========================================");
      ...
      size_t solution[26] = {36, 10, 7,  40, 33, 16, 42, 32, 6,
                             20, 8,  35, 22, 14, 41, 23, 4,  29,
                             24, 31, 21, 27, 13, 18, 38, 37};
      bool passed = true;
      char *target = new char[2];
      target[1] = a_null_byte;
      for (int i = 0; i < 26; ++i) {
    ...
    // Test Find Last Of 2
    if (test_number == 58 || test_number == TEST_ALL ||
        test_number == TEST_FLO) {
      printf("======================================== 58 "
             "========================================");
    ...
    // Test Find Last Of 3
    if (test_number == 59 || test_number == TEST_ALL ||
        test_number == TEST_FLO) {
      printf("======================================== 59 "
             "========================================");
    ...
    // Test Find Last Of 4
    if (test_number == 60 || test_number == TEST_ALL ||
        test_number == TEST_FLO) {
      printf("======================================== 60 "
             "========================================");
    ...
    // Test Find Last Of 5
    if (test_number == 61 || test_number == TEST_ALL ||
        test_number == TEST_FLO) {
      printf("======================================== 61 "
             "========================================");
    ...
    // Test Find Last Of 6
    if (test_number == 62 || test_number == TEST_ALL ||
        test_number == TEST_FLO) {
      printf("======================================== 62 "
             "========================================");
    ...
    // Test Find Last Of 7
    if (test_number == 63 || test_number == TEST_ALL ||
        test_number == TEST_FLO) {
      printf("======================================== 63 "
             "========================================");
    ...
    // Test Find Last Of 8
    if (test_number == 64 || test_number == TEST_ALL ||
        test_number == TEST_FLO) {
      printf("======================================== 64 "
             "========================================");
    ...
    // Test Find Last Of 9
    if (test_number == 65 || test_number == TEST_ALL ||
        test_number == TEST_FLO) {
      printf("======================================== 65 "
             "========================================");
    ...
    if (test_number == 66 || test_number == TEST_ALL ||
        test_number == TEST_FLO) {
      printf("======================================== 66 "
             "========================================");
    ...
    if (test_number == 67 || test_number == TEST_ALL ||
        test_number == TEST_FLO) {
      printf("======================================== 67 "
             "========================================");
      printf("\nRUNNING TEST FIND_LAST_OF 11 ...\n");
      printf("  ORIGINAL STRING: "
             "\"usggAD9345uu3ibeLKE:Ffuf7t8uwgefhsnhgdgtkhm\"\n");
    ...
    if (test_number == 68 || test_number == TEST_ALL ||
        test_number == TEST_FLO) {
      printf("======================================== 68 "
             "========================================");
    ...
    if (test_number == 69 || test_number == TEST_ALL ||
        test_number == TEST_FLO) {
      printf("======================================== 69 "
             "========================================");
    ...
    if (test_number == 70 || test_number == TEST_ALL ||
        test_number == TEST_FLO) {
      printf("======================================== 70 "
             "========================================");
    ...
    if (test_number == 71 || test_number == TEST_ALL ||
        test_number == TEST_FLO) {
      printf("======================================== 71 "
             "========================================");
    ...
    if (test_number == TEST_ALL) {
      ...
      printf(" ERASE TESTS PASSED: %d/11 (%.2f%%)\n", erase_correct,
             ((float)erase_correct / 11) * 100);
      printf(" INSERT TESTS PASSED: %d/11 (%.2f%%)\n", insert_correct,
             ((float)insert_correct / 11) * 100);
      printf(" REPLACE TESTS PASSED: %d/20 (%.2f%%)\n", replace_correct,
             ((float)replace_correct / 20) * 100);
      printf(" FIND_FIRST_OF TESTS PASSED: %d/14 (%.2f%%)\n", ffo_correct,
             ((float)ffo_correct / 14) * 100);
      printf(" FIND_LAST_OF TESTS PASSED: %d/15 (%.2f%%)\n", num_correct,
             ((float)num_correct / 15) * 100);

      num_correct += ffo_correct += replace_correct += insert_correct +=
          erase_correct;

      printf(" TOTAL TESTS PASSED: %d/71 (%.2f%%)\n", num_correct,
             ((float)num_correct / 71) * 100);
      printf("================================================================="
             "===================\n");
